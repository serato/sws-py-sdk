...
class Identity(Service):
    ...
    def create_device_flow_authorization(self, code_challenge, code_challenge_method='s256'):
        """ POST /tokens/device Creates a new request for a device flow authorization

            code_challenge: str
                Code challenge for the request. This should be generated by the client.
            code_challenge_method: str
                Code challenge method. Currently only supports 's256'
        """
    ...
    def exchange_device_code_for_tokens(self, device_code, code_verifier):
        """ POST /tokens/device/code Exchanges a device code for access/refresh tokens

            device_code: str
                Device code for the authorization request.
            code_verifier: str
